...
/*s     ,s       ,s       ,*/_______ ,_______ ,_______   ,_______       ,_______       ,MO(3)      ,KC_DEL     ,_______ /* ,s          ,s       ,s       ,*/
    ...
    [2] = LAYOUT(
        // KC_EQL for ticks and backticks on swedish layout
...
_______ ,KC_F2   ,KC_F3   ,KC_F4     ,KC_F5   ,KC_F6    /*,mcu     ,mcu*/   ,KC_LEFT ,KC_DOWN ,KC_UP     ,KC_RIGHT ,XXXXXXX ,XXXXXXX ,
_______ ,KC_NUBS ,KC_F9   ,KC_F10    ,KC_F11  ,KC_F12     ,_______ ,KC_EQL  ,KC_MNXT ,KC_WH_D ,_______   ,_______  ,KC_MPLY ,_______ ,
